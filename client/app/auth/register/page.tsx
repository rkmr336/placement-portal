...
export default function Register() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24, position: 'relative', overflow: 'hidden' }}>
      <div className="orb" style={{ width: 400, height: 400, background: '#43e97b', top: -100, right: -100 }} />
      <div className="orb" style={{ width: 300, height: 300, background: '#7c5cfc', bottom: -50, left: -50 }} />
      ...
      <div className="animate-fadeup" style={{ width: '100%', maxWidth: 420, position: 'relative', zIndex: 5 }}>
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <p style={{ color: 'var(--muted)', fontSize: 14, marginTop: 8 }}>Create your free account today</p>
        </div>
        ...
        <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 24, padding: 32 }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            <div>
              ...
              <input type="text" name="name" value={formData.name} onChange={handleChange}
                placeholder={formData.role === 'company' ? 'Acme Technologies' : 'Rahul Kumar'} required className="input" />
            </div>
            <div>
          ...
          <p style={{ textAlign: 'center', marginTop: 20, fontSize: 13, color: 'var(--muted)' }}>
            ...
            <a href="/auth/login" style={{ color: '#a78bfa', fontWeight: 600, textDecoration: 'none' }}>Sign in</a>
          </p>
        </div>
      </div>
    </div>
